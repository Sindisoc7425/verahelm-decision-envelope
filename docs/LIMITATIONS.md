...
- Key distribution, rotation, and customer authority validation are deployment responsibilities. A pull-request gate must pin the trusted key fingerprint outside pull-request-controlled content.
